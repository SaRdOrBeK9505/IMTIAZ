...
# ============================================================================
# 🤖 STREAMING CHAT EMOJIS VA INDICATORS (Mira bot kabi)
# ============================================================================

def ai_chat_welcome(lang: str = 'uz') -> str:
    """AI assistant-ga salamlash"""
    if lang == 'ru':
        return "🤖 Привет! Я ваш AI-помощник. Как я могу вам помочь?"
    elif lang == 'en':
        return "🤖 Hello! I'm your AI assistant. How can I help you?"
    return "🤖 Salom! Men sizning AI yordamchingizman. Qanday yordam berishim mumkin?"


def streaming_thinking_status(lang: str = 'uz') -> str:
    """O'ylanyapman holati"""
    if lang == 'ru':
        return "🧠 Подумаю..."
    elif lang == 'en':
...
def streaming_processing_status(lang: str = 'uz', tool_name: str = '') -> str:
    """Jarayon ketayotgan holati"""
    action = f"({tool_name})" if tool_name else ""
    if lang == 'ru':
        return f"⚙️ Обработка запроса {action}..."
    elif lang == 'en':
        return f"⚙️ Processing {action}..."
    return f"⚙️ So'rovni qayta ishlayapman {action}..."


def streaming_done_emoji() -> str:
    """Tamomlandi emoji"""
    return "✅"


def streaming_error(error_msg: str, lang: str = 'uz') -> str:
    """Xatolik xabari"""
    if lang == 'ru':
        return f"❌ Ошибка: {error_msg}\n\n_Попробуйте еще раз._"
    elif lang == 'en':
        return f"❌ Error: {error_msg}\n\n_Please try again._"
    return f"❌ Xatolik: {error_msg}\n\n_Iltimos, qayta urinib ko'ring._"


def stream_typing_hint(lang: str = 'uz') -> str:
...
# Streaming-specific emoji mappings
STREAMING_EMOJIS = {
    'ai': '🤖',
    'thinking': '🧠',
    'processing': '⚙️',
